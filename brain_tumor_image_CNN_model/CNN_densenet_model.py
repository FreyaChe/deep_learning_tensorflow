...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 12 11:06:10 2026
...
class CNN_model(tf.keras.Model):
    def __init__(self, dropout_rate):
        ...
        self.seq = tf.keras.Sequential([
          tf.keras.applications.DenseNet121(include_top=False, input_shape=(256,256,3)),
...
checkpoint_path = '/Users/freya/Downloads/brain_tumor_image/CNN_model/model_densenet.weights.h5'
...
# In[training]
Model = CNN_model(dropout_rate = 0.2)

initial_epoch=2 # default is 0, the starting epoch would be n+1 
...
class_weight = {
    0: 1.0,
    1: 1.0,
    2: 2,  # set higher weight for normal 
    3: 1.0
}

Model.fit(train_dataset, epochs=300, validation_data=val_dataset, callbacks=[earlystop_callback, checkpoint_callback], initial_epoch=initial_epoch, class_weight=class_weight)
